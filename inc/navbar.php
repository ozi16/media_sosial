      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-link active me-3" aria-current="page" href="index.php">Beranda</a>
            <a class="nav-link me-3" href="?pg=profile">Profile</a>
            ...
            <a class="nav-link me-3" href="keluar.php">Logout</a>
          </div>
        </div>
      </div>
    </nav>